...
internal sealed class GetAllUsersQueryHandler(IGetAllUsersQueryService service)
    : IQueryHandler<GetAllUsersQuery, Result<IReadOnlyCollection<SimpleUserDto>>>
{
    public async Task<Result<IReadOnlyCollection<SimpleUserDto>>> Handle(GetAllUsersQuery request, CancellationToken cancellationToken)
    {
        // TODO pagination
