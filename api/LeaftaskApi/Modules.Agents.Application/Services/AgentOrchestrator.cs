...
public class AgentOrchestrator(IAgentKernelFactory kernelFactory)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        chatHistory.AddSystemMessage($"""
                                      ...
                                      2. Before creating, updating, or deleting any resource, you MUST ensure you have the correct GUID identifiers. If you do not have them in the conversation history, call the appropriate 'Get' or 'Search' tool first. Never guess or hallucinate a GUID.
