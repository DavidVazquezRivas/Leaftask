...
public static class ProjectPermissionsSeeder
{
    ...
    [
        (new Guid("b1c2d3e4-0001-0000-0000-000000000001"), "project.settings", "Configuración básica del proyecto",
            ConfigurationGroupId),
        (new Guid("b1c2d3e4-0002-0000-0000-000000000001"), "project.custom-fields", "Configurar campos personalizados",
            ConfigurationGroupId),
        (new Guid("b1c2d3e4-0003-0000-0000-000000000001"), "project.roles", "Configurar roles y permisos",
            ConfigurationGroupId),
        (new Guid("b1c2d3e4-0004-0000-0000-000000000001"), "project.invite-members", "Invitar miembros",
            ConfigurationGroupId),
        (new Guid("b1c2d3e4-0005-0000-0000-000000000001"), "project.member-roles", "Modificar Rol Miembros",
            ConfigurationGroupId),
        (new Guid("b1c2d3e4-0006-0000-0000-000000000001"), "project.remove-members", "Expulsar miembros",
            ConfigurationGroupId),
        (new Guid("b1c2d3e4-0007-0000-0000-000000000001"), "work-items.create", "Crear elementos de trabajo",
            WorkItemsGroupId),
        (new Guid("b1c2d3e4-0008-0000-0000-000000000001"), "work-items.edit-definition",
            "Modificar definición (Título, Descripción, Fecha Límite, Padre, Prioridad)", WorkItemsGroupId),
        (new Guid("b1c2d3e4-0009-0000-0000-000000000001"), "work-items.edit-estimation",
            "Modificar estimación (Estimación Horas)", WorkItemsGroupId),
        (new Guid("b1c2d3e4-0010-0000-0000-000000000001"), "work-items.assign-self",
            "Modificar asignación (asignar a uno mismo)", WorkItemsGroupId),
        (new Guid("b1c2d3e4-0011-0000-0000-000000000001"), "work-items.assign-any",
            "Modificar asignación (asignar a X)", WorkItemsGroupId),
        (new Guid("b1c2d3e4-0012-0000-0000-000000000001"), "work-items.edit-own-progress",
            "Modificar avance y dedicación (asignadas)", WorkItemsGroupId),
        (new Guid("b1c2d3e4-0013-0000-0000-000000000001"), "work-items.edit-any-progress",
